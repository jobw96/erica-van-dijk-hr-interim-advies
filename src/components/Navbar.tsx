          ...
          <div className="flex items-center justify-between h-12">
                ...
                {links.map((link, index) => (
                  ...
                  >
                    <MotionLink
                      ...
                      animate={{ color: isTransparent ? '#ffffff' : '#374151' }}
                      whileHover={{ color: '#8E170B', y: -1 }}
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.button
                ...
                animate={{ color: isTransparent ? '#ffffff' : '#111827' }}
                whileHover={{
                  scale: 1.05,
            ...
            <>
              ...
              >
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-100">
                  ...
                  >
                    <X size={24} className="text-gray-900" aria-hidden="true" />
                  </motion.button>
                </div>
