    ...
    >
      <h3>
        <button
          ...
          id={headingId}
        >
          <span className="text-lg font-satoshi-bold text-gray-900 pr-8 group-hover:text-[#8E170B] transition-colors tracking-tight font-normal">
            {faq.question}
          </span>
          <motion.div
...
export const FAQ: React.FC<FAQProps> = ({ className }) => {
  ...
  return (
    <section
      ...
      className={`py-20 md:py-32 ${className || 'bg-white'}`}
    >
