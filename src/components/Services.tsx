...
const cardHoverVariants = {
  ...
  hover: { y: -5, boxShadow: "0 20px 40px -10px rgba(142, 23, 11, 0.08)" }
};

const iconBgVariants = {
  rest: { backgroundColor: 'rgba(142, 23, 11, 0.05)' },
  hover: { backgroundColor: '#8E170B' }
};

const iconVariants = {
  rest: { color: '#8E170B', scale: 1, rotate: 0 },
  hover: {
    color: 'white',
    scale: 1.1,
    rotate: -5,
...
const arrowContainerVariants = {
  rest: { borderColor: 'rgb(243 244 246)' },
  hover: { borderColor: '#8E170B' }
};
            ...
            return (
              ...
              >
                <motion.article
                  ...
                  className="bg-white rounded-2xl p-8 border border-gray-100 h-full flex flex-col relative overflow-hidden min-h-[320px]"
                >
                  {/* Gradient Overlay on Hover */}
                  <motion.div
                    variants={gradientVariants}
                    className="absolute inset-0 bg-gradient-to-br from-[#8E170B]/5 to-transparent pointer-events-none"
                    aria-hidden="true"
                  />
                  ...
                  <motion.div
                    ...
                    className="mt-6 w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center relative z-10"
                    aria-hidden="true"
                  >
