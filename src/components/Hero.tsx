...
export const Hero: React.FC = () => {
  ...
  return (
    <section ref={heroRef} id="home" aria-labelledby="hero-heading" className="relative w-full min-h-[100dvh] flex items-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 lg:px-12 w-full h-full flex flex-col justify-center items-start">
        <div className="space-y-6 md:space-y-8 max-w-3xl">
          ...
          <div className="space-y-1 md:space-y-2">
            ...
            <span className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-light text-white leading-[1.1] min-h-[1.1em] block">
              {showAdvies ? (
                <GradualSpacing
                  text="& Advies"
                  duration={0.5}
          ...
          >
            ...
            >
              <Button asChild className="h-11 px-7 text-base bg-white text-[#8E170B] hover:bg-gray-100 hover:text-[#8E170B] border border-white shadow-lg hover:shadow-xl rounded-xl transition-all duration-300">
                <Link to="/contact" aria-label="Neem contact op met Erica van Dijk">
                  Neem contact
                </Link>
              </Button>
            </motion.div>
