        ...
        <motion.div initial={{
          ...
          <Link to="/contact">
            <motion.button whileHover={{
              ...
              duration: 0.2
            }} className="bg-white text-[#8E170B] px-8 py-4 rounded-lg font-medium text-base md:text-lg shadow-lg w-full sm:w-auto">
              Neem contact
            </motion.button>
          </Link>
          <Link to="/experience">
            <motion.button whileHover={{
              ...
              duration: 0.2
            }} className="border-2 border-white/80 text-white px-8 py-4 rounded-lg font-medium text-base md:text-lg w-full sm:w-auto backdrop-blur-sm">
              Ervaringen
            </motion.button>
          </Link>
        </motion.div>
