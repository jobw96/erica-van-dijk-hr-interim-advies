        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <motion.div style={{ y: leftY }} className="lg:col-span-4 flex flex-col justify-center">
            ...
            >
              ...
              <h2
                id="reviews-heading"
                className="text-4xl md:text-5xl font-satoshi-black text-gray-900 mb-6 leading-tight tracking-tight"
              >
              ...
              {/* Navigation Arrows */}
              <nav aria-label="Review navigatie" className="flex gap-4">
                <motion.button
          ...
          <motion.div
            style={{ y: middleY }}
            className="hidden lg:block lg:col-span-3 h-full min-h-[400px] lg:min-h-[500px]"
          >
            <motion.div
          ...
          <motion.div
            style={{ y: rightY }}
            className="lg:col-span-5 h-full min-h-[400px] lg:min-h-[500px]"
          >
            <motion.blockquote
              key={currentIndex}
              initial={{ opacity: 0, x: 20 }}
