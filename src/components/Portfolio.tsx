  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <motion.div
          style={{ y: headerY }}
          className="flex flex-col items-start md:items-end mb-16 md:mb-24 text-left md:text-right"
        >
          <motion.span
        ...
        <div className="space-y-20 md:space-y-32">
          {videos.map((video, index) => (
            <article
              key={index}
              className={`flex flex-col lg:flex-row gap-10 lg:gap-20 items-center ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}
            >
              {/* Image Side */}
              <motion.div
              ...
              >
                <motion.a
                  ...
                  whileHover="hover"
                  initial="rest"
                  className="block overflow-hidden rounded-2xl shadow-2xl aspect-video relative group cursor-pointer"
                  aria-label={`Bekijk video: ${video.title} (opent in nieuw tabblad)`}
                >
                  <motion.img
              ...
              >
                ...
                <h3 className="text-3xl md:text-4xl font-satoshi-black text-gray-900 mb-6 leading-tight tracking-tight font-normal">
                  {video.title}
                </h3>
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ x: 5, backgroundColor: '#701209' }}
                  ...
                  aria-label={`Bekijk video ${video.title} op YouTube (opent in nieuw tabblad)`}
                >
                  Bekijk video
                </motion.a>
              </motion.div>
